...
void tid_B_back_entry(void *par)
{
...
{
    tid_B_back = rt_thread_create("tid_B_back",
                                   tid_B_back_entry, RT_NULL,
                                   2048 ,
                                   12 , 10);
    if(tid_B_back != RT_NULL)
        rt_thread_startup(tid_B_back);
}

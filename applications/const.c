...
const rt_int32_t speed1 = 5000;  	//直行速度
const rt_int32_t speed2 = 4750;		//转弯内圈速度
const rt_int32_t speed3 = 5250;		//转弯外圈速度
...
const rt_int32_t spd_big_tlf_right = 4950;//大圆左转

const rt_int32_t spd_big_tri_left = -4950;
const rt_int32_t spd_big_tri_right = 5550;//大圆右转

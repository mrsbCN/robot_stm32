...
const rt_int32_t speed1 = 1500;  	//直行速度
const rt_int32_t speed2 = 1400;		//转弯内圈速度
const rt_int32_t speed3 = 1900;		//转弯外圈速度
...
const rt_int32_t spd_big_tlf_left = -1873;	
const rt_int32_t spd_big_tlf_right = 1673;//大圆左转

const rt_int32_t spd_big_tri_left = -1673;
const rt_int32_t spd_big_tri_right = 1873;//大圆右转
...
const rt_int32_t dis_for_tlf_left45 = 495;
const rt_int32_t dis_for_tlf_right45 = 636;
...
const rt_int32_t be_to_left1 = 1900;
const rt_int32_t left1_to_left3 = 2400;
...
const rt_int32_t right3_to_right1 = 2400;
const rt_int32_t right1_to_be = 1900;
